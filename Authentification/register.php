...
<body class=" flex items-center justify-center min-h-screen bg-cover bg-center bg-black" >
    <form method="POST" class="bg-white p-6 rounded-lg shadow-md w-full max-w-xl mx-auto">

        <h2 class="text-2xl font-bold text-yellow-500 mb-4 text-center">Register</h2>

        <div class="mb-4">
            <label for="name" class="block text-sm font-medium text-gray-600">Name</label>
            <input type="text" name="name" id="name" placeholder="Your name" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-red-600 focus:outline-none">
        </div>
        <div class="mb-4">
